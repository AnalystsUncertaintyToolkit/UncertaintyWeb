...
<div class = "rightA">
Hypothetical outcome plots display possible outcomes as frames in an animation. This technique can make uncertainty visceral and hard to ignore.
</div>
...
<div class = "rightA">
Studies indicate/show that people are able to infer the distribution of data from the frequency of occurrences with surprising accuracy and therefore estimate 
...
```{r fig.align="center", echo=FALSE, alt = "Example of Hypothetical Outcome Plot"}
