...
## Hypothetical Outcome Plots (HOPs) test
...
<div class = "rightA">
Frame rate is an important design consideration. The animation must be sufficiently fast enough to allow the audience to view enough samples to reduce sampling error, 
